# Contributing to can-control-plugin
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-control-plugin) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-control-plugin, you can start by going to its [fork page](https://github.com/canjs/can-control-plugin/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-control-plugin
```
